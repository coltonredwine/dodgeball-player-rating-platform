...
export async function POST(request: Request) {
  ...
  await setStringSetting(leagueId, RATE_PAGE_TITLE_KEY, pageTitle);
  ...
  if (urlRaw) {
    ...
    await setStringSetting(leagueId, RATE_PAGE_BUTTON_TITLE_KEY, title || "Open link");
    await setStringSetting(leagueId, RATE_PAGE_BUTTON_URL_KEY, url);
  } else {
