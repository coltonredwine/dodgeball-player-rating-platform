...
export function OffenseStatGlyph({ size = 14, className = "" }: GlyphProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DefenseStatGlyph({ size = 14, className = "" }: GlyphProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PsychStatGlyph({ size = 14, className = "" }: GlyphProps) {
  return (
    ...
    <img
      ...
      style={{
        filter:
          "brightness(0) saturate(100%) invert(32%) sepia(55%) saturate(900%) hue-rotate(286deg) brightness(82%) contrast(92%)",
      }}
    />
  );
}

export function CalcStatGlyph({ size = 14, className = "" }: GlyphProps) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img
      src="/calc-glyph.png"
      ...
      style={{
        filter:
          "brightness(0) saturate(100%) invert(72%) sepia(48%) saturate(520%) hue-rotate(5deg) brightness(95%) contrast(92%)",
      }}
    />
  );
}
